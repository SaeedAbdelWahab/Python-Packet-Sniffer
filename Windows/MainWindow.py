...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(10, 10, 40, 15))
        ...
        self.PacketTree.setGeometry(QtCore.QRect(9, 351, 761, 155))
        self.PacketTree.setObjectName(_fromUtf8("PacketTree"))
        self.PacketTable = QtGui.QTreeWidget(self.centralwidget)
        self.PacketTable.setGeometry(QtCore.QRect(9, 44, 761, 301))
        self.PacketTable.setObjectName(_fromUtf8("PacketTable"))
        self.PacketTable.header().setResizeMode(QtGui.QHeaderView.ResizeToContents)
        self.PacketTable.header().setStretchLastSection(False)
        self.FilterText = QtGui.QTextEdit(self.centralwidget)
        self.FilterText.setGeometry(QtCore.QRect(60, 0, 451, 31))
